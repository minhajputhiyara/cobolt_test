                    ...
                    a = function() {
                        function a() {
                            ...
                            this._configStore = (b = {
                                ...
                                defaultCustomData: {},
                                estRuleEngine: {}
                            }, l(b, "defaultCustomData", {}), l(b, "browserProperties", {}), l(b, "eventValidation", {}), l(b, "protectedDataMode", {}), l(b, "clientHint", {}), l(b, "ccRuleEvaluator", {}), b)
                        }
                        h(a, [{
                            key: "set",
            ...
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    function g(c, f) {
                        ...
                        if (h || j.length < e) {
                            h = new Image();
                            f != null && f.errorHandler != null && (h.onerror = f.errorHandler);
                            f = b.trigger(c);
                            d(f, function(a) {
                                return a
                            }) && (h.referrerPolicy = "origin");
                            g && h.setAttribute("attributionsrc", i);
                            h.src = j;
                            return !0
                        }
                        return !1
